...
from tensorrt_llm.runtime.generation import CUASSERT, _Runtime, LogitsProcessor, ModelConfig, RuntimeTensor, SamplingConfig, StoppingCriteria, _tile_beam_width
...
class EmbeddingSession(object):
    ...
    def decode_regular(self,
        ...
        if should_stop is not None and should_stop.item():
            ...
            # TODO(ilyaonoff) return somthething 
            # if self.is_medusa_mode:
